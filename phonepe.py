...
if select == "HOME":
    ...
    with col2:
        st.image(Image.open(r"C:\Users\lenovo\Prime_Classes\LabmentixProject\ThirdProject\Phone_pay\download1.jpg"),width= 600)
    ...
    with col6:
        st.image(Image.open(r"C:\Users\lenovo\Prime_Classes\LabmentixProject\ThirdProject\Phone_pay\images.jpg"),width= 600)
